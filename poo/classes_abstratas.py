...
# class Log(metaclass=ABCMeta): mesmaa coisa
# uma metaclass cria classes.
# para ser uma classe abstrata, precisa herdar de uma metaclass
# ou de ABC


class Log(ABC):  # "ABC = Log é uma classe abstrata."
    @abstractmethod
    def _log(self, msg): ...
...
class LogPrintMixin(Log):
    def _log(self, msg):  # como herdo de classe abstrata, manter padrao
